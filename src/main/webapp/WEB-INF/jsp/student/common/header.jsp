...
<head>
    ...
    <title><%=request.getParameter("pageTitle")%> ——学生系统</title>
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="${pageContext.request.contextPath}/indexStudentInfo.html" class="site_title"><i
                            class="fa fa-paw"></i> <span>学生管理</span></a>
                </div>
